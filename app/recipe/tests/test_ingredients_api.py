...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        Ingredient.objects.create(user=user2, name='Santan')

        ingredient = Ingredient.objects.create(user=self.user, name='Salam')
